...
public class searchPage {
    ...
    searchPageUsingPageFactory searchPage;
    @BeforeMethod
    public void beforeMethod() {
        ...
        searchPage=new searchPageUsingPageFactory(driver);
    ...
    public void TestSearchFunctionality(){
        ...
        Assert.assertEquals(driver.getCurrentUrl(),"https://qamoviesapp.ccbp.tech/search","search page not found");
        searchPage.searchMovies("the");
        searchPage.clickOnSearchBtn();
        System.out.println(searchPage.countMovies());
        searchPage.clearSearch();
        searchPage.searchMovies("titan");
        searchPage.clickOnSearchBtn();
        System.out.println(searchPage.countMovies());
    }
}
